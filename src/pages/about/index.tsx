  ...
  return (
    <Layout location={props.location} title={siteTitle} navLinks={navLinks}>
      ...
      <p>
        ...
        satellite dishes for a while, he went off and did network stuff, but
        we both fell ass backwards into software. We've got weird backgrounds,
        but they helped make us who we are today.
      </p>
      <p>
        ...
        machine learning, and a ton of resources for falling ass-backwards
